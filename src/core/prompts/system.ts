...
export const SYSTEM_PROMPT = async (
	...
	mcpHub: McpHub,
) => `You are HuoHuaAI, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.
